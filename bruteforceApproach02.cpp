/**
 * Filename: bruteforceApproach02.cpp
 ...
 * Date: 2023-05-14
 *
 * Compilation: mpic++ bruteforceApproach02.cpp -o desBrute02 -lcryptopp
 * Execution: mpiexec -n [number of processes] ./desBrute02 [key]
 * 
 * Dependencies:
...
int main(int argc, char *argv[]) {
    ...
    // Naively distribute the work among processes
    mylower = rank;
    myupper = upper;
    ...
    for (long i = mylower; i < myupper; i += N) {
